...
btn_ac = Button(kalkulator, text='Clear', width=13, font=('arial', 20), bg='#434242', activebackground='light blue',
fg='#22A39F', bd=0, relief=FLAT, command=bersih_all)
btn_ac.grid(row=1, column=0, padx=1, pady=1, columnspan=3)

btn_bersih = Button(kalkulator, text='Del', width=4, font=('arial', 20), bg='#434242', activebackground='light blue',
fg='#22A39F', bd=0, relief=FLAT, command=bersih)
btn_bersih.grid(row=5, column=2, padx=1, pady=1)

btn_equal = Button(kalkulator, text='= ', width=4 , font=('arial', 20), bg='#434242', activebackground='light blue',
fg='#22A39F', bd=0, relief=FLAT, command=layar_answer,)
...
for i in range(4):
    btn = Button(kalkulator, text=operators[i], width=4, font=('arial', 20), bg='#434242', activebackground='light blue', fg='#22A39F', bd=0, relief=FLAT, command=partial(place_operator, operators[i]))
